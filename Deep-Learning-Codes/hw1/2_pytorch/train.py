...
criterion = F.cross_entropy# Note: this does the softmax layer loss at the end
if args.cuda:
    model.cuda()
...
optimizer = torch.optim.RMSprop(model.parameters(), lr=args.lr)# tried Adagrad, Adadelta and Adam 
#############################################################################
#                             END OF YOUR CODE                              #
#############################################################################
