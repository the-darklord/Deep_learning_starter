  ...
  def train(self, X, y, X_val, y_val, 
    ...
    for it in range(num_iters):
      ...
      for p in model:
        ...
        if update == 'sgd':
        ...
        elif update == 'momentum':# learning rate is the velocity in gradient direction
          ...
          #####################################################################
          self.step_cache[p] = momentum * self.step_cache[p] - learning_rate * grads[p] # dx is the velocity
          ...
          if not p in self.step_cache:
#            print(np.zeros(grads[p].shape))
#            print(grads[p].shape)
#            s1, s2 = grads[p].shape
#            print(np.random.rand(s1))
            self.step_cache[p] = np.zeros(grads[p].shape)
          #####################################################################
